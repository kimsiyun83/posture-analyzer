...
export const RECORD_LABELS:Record<string,string>={inbody:"인바디 체성분 검사",posture:"4방향 체형 검사",balance:"한발서기",chair:"의자 일어서기",scratch:"어깨 스크래치",shoulder:"어깨 각도",elbow:"팔꿈치 각도"};
export function validCustomerRecord(kind:unknown,d:unknown):boolean {
 ...
 if(kind==="inbody")return false; // Dedicated authenticated endpoint validates this richer report.
